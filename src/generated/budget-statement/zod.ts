...
import {
    ...
    BudgetStatement,
    BudgetStatementData,
    BudgetStatementDataInput,
    BudgetStatementInput,
    BudgetStatus,
    Comment,
    CommentAuthor,
    CommentAuthorInput,
...
export function AccountUpdateInputSchema(): z.ZodObject<
    Properties<AccountUpdateInput>
> {
...
export function AddAccountActionSchema(): z.ZodObject<
    Properties<AddAccountAction>
> {
...
export function AddAuditReportActionSchema(): z.ZodObject<
    Properties<AddAuditReportAction>
> {
...
export function AddCommentActionSchema(): z.ZodObject<
    Properties<AddCommentAction>
> {
...
export function AddLineItemActionSchema(): z.ZodObject<
    Properties<AddLineItemAction>
> {
...
export function AddVestingActionSchema(): z.ZodObject<
    Properties<AddVestingAction>
> {
...
export function AuditReportInputSchema(): z.ZodObject<
    Properties<AuditReportInput>
> {
...
export function BudgetStatementSchema(): z.ZodObject<
    Properties<BudgetStatement>
> {
...
export function BudgetStatementActionSchema() {
    return z.union([
        ...
        AddAuditReportActionSchema(),
        AddCommentActionSchema(),
        AddLineItemActionSchema(),
        AddVestingActionSchema(),
        DeleteAccountActionSchema(),
        DeleteAuditReportActionSchema(),
        DeleteCommentActionSchema(),
        DeleteLineItemActionSchema(),
        DeleteVestingActionSchema(),
        InitActionSchema(),
        UpdateAccountActionSchema(),
        UpdateCommentActionSchema(),
        UpdateLineItemActionSchema(),
        UpdateVestingActionSchema(),
    ]);
}

export function BudgetStatementDataSchema(): z.ZodObject<
    Properties<BudgetStatementData>
> {
...
export function BudgetStatementDataInputSchema(): z.ZodObject<
    Properties<BudgetStatementDataInput>
> {
...
export function BudgetStatementInputSchema(): z.ZodObject<
    Properties<BudgetStatementInput>
> {
...
export function CommentUpdateInputSchema(): z.ZodObject<
    Properties<CommentUpdateInput>
> {
...
export function DeleteAccountActionSchema(): z.ZodObject<
    Properties<DeleteAccountAction>
> {
...
export function DeleteAuditReportActionSchema(): z.ZodObject<
    Properties<DeleteAuditReportAction>
> {
...
export function DeleteCommentActionSchema(): z.ZodObject<
    Properties<DeleteCommentAction>
> {
...
export function DeleteLineItemActionSchema(): z.ZodObject<
    Properties<DeleteLineItemAction>
> {
...
export function DeleteVestingActionSchema(): z.ZodObject<
    Properties<DeleteVestingAction>
> {
...
export function DocumentFileInputSchema(): z.ZodObject<
    Properties<DocumentFileInput>
> {
...
export function FteSchema(): z.ZodObject<Properties<Fte>> {
    return z.object<Properties<Fte>>({
        __typename: z.literal("FTE").optional(),
        forecast: z.array(FteForecastSchema().nullable()),
        value: z.number(),
    });
}

export function FteForecastSchema(): z.ZodObject<Properties<FteForecast>> {
    return z.object<Properties<FteForecast>>({
        __typename: z.literal("FTEForecast").optional(),
        month: z.string(),
        value: z.number(),
    });
}

export const InitSchema = z.enum(["INIT"]);

export function InitActionSchema(): z.ZodObject<Properties<InitAction>> {
    return z.object<Properties<InitAction>>({
        input: z.lazy(() => BudgetStatementInputSchema()),
        type: InitSchema,
    });
}
...
export function LineItemDeleteInputSchema(): z.ZodObject<
    Properties<LineItemDeleteInput>
> {
...
export function UpdateAccountActionSchema(): z.ZodObject<
    Properties<UpdateAccountAction>
> {
...
export function UpdateCommentActionSchema(): z.ZodObject<
    Properties<UpdateCommentAction>
> {
...
export function UpdateLineItemActionSchema(): z.ZodObject<
    Properties<UpdateLineItemAction>
> {
...
export function UpdateVestingActionSchema(): z.ZodObject<
    Properties<UpdateVestingAction>
> {
